...
(function() {
  var BUMP_FACTOR, DEFAULT_HEARTBEAT, REGISTRY_BIND_HOST, REGISTRY_BIND_PORT, REGISTRY_BIND_PROTO, Registry, VERBOSE, argv, checkServices, deregisterService, deregisteredRemoteService, findServices, foundRemoteServices, getHealthyServiceByName, getRemoteServiceByName, getService, getServiceByClientId, getServiceById, heartbeats, host, isHealthy, join, join_string, log, minimist, port, ref, registerService, registered, registeredRemoteService, registry, registry_methods, registry_options, remote_registered, somata,
