...
(function() {
  var BUMP_FACTOR, DEFAULT_BRIDGE_PORT, DEFAULT_HEARTBEAT, DEFAULT_REGISTRY_PORT, EventEmitter, REGISTRY_BIND_HOST, REGISTRY_BIND_PORT, REGISTRY_BIND_PROTO, Registry, VERBOSE, argv, async, bridge_string, checkServices, deregisterService, findServices, getHealthyServiceByName, getRemoteServiceByName, getService, getServiceByClientId, getServiceById, heartbeats, host, isHealthy, log, minimist, port, ref, registerService, registered, registry, registry_methods, registry_options, remote_registered, somata,
  ...
  Registry = (function(superClass) {
    ...
    Registry.prototype.register = function() {
      ...
      return this.binding.on('ping', (function(_this) {
        return function(client_id, message) {
          return _this.gotPing(client_id);
        };
      })(this));
    };
  ...
  if ((bridge_string = argv.t || argv.bridge) && false) {
    ref = bridge_string.split(':'), host = ref[0], port = ref[1];
